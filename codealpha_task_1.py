...
Original file is located at
    https://colab.research.google.com/drive/1aGrlFblHY3BR2gZBL0R_Zl9VBXlwJMIj
"""
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    with gr.Row():
        ...
        # Right Side: Output
        with gr.Column():
            target_language = gr.Dropdown(choices=language_names, value="Urdu", label="Target Language")
